...
import { statusColor, riskColor, formatDate } from '../utils/helpers.js'
  ...
  return (
    <div className={styles.page}>
      ...
      <div className={styles.pageHeader}>
        ...
        <Button variant="primary" icon={<Plus size={15} />} onClick={() => addAlert('New case form coming soon.', 'info')}>
          New Case
        </Button>
      </div>
          ...
          <tbody>
            {filtered.length === 0 ? (
              ...
              >
                ...
                <td><Badge label={c.status} color={statusColor(c.status)} dot /></td>
                <td><Badge label={c.priority} color={riskColor(c.priority)} /></td>
